...
<body onload="FP_preloadImgs(/*url*/'asset/button/exploreA.png',/*url*/'asset/button/exploreB.png',/*url*/'asset/button/exploreC.png'); initPage();" style="background: url('asset/bg/table_top.png') no-repeat;background-color:gray;">
